...
function Blog(body,date,image){
    ...
    Blog.prototype.toHTML=function(i){
        ...
        if(this.image){
            ...
            blogText+="<strong>"+(this.date.shortFormat())+"</strong><br/><table><tr><td><img src='./assets/"+this.image+"'/></td><td style='vertical-align:top'>"+this.body+"</td></tr></table><em style='font-size:12px'>"+this.signature+"</em></p>";
        }else{
            blogText+=i?"<p style='background-color:#EEEEEE'>":"<p>";
...
var blogs=[
    ...
    new Blog('I ordered a new cube ...',new Date('08/05/2020'),"cube777.png"),
    new Blog("Got the new cube I ordered. It's a real pearl.", new Date("08/14/2008"),"cube778.png"),
    ...
    new Blog("Met up with some fellow cubers to discuss the prospect of a 7x7x7 cube. Mixed feelings.", new Date("08/29/2008"),"cube779.jpg"),
